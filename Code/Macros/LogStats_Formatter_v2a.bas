...
'*                                                                                  *
'* VERSION 01 INITIAL IMPLEMENTATION                        ##REDACTED## AUG 2010 GXG   *
'* VERSION 02 AMEND PLACEMENT OF RUNTIME PARAMS IN REPORT            ##REDACTED## GXG   *
'************************************************************************************
    ...
    'Save as excel 95/97 format spreadsheet in same directory as txt file was loaded from.
    ...
    If Dir(s2 & ".xls") <> "" Then 'file exists
        Kill (s)
    End If
