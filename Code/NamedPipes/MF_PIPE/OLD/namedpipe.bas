...
Declare Function OpenPipe Lib "npdll.dll" (ByVal sPipe As String, ByVal lReadTimeout As Long, ByVal lWriteTimeout As Long, ByVal sUser As String, ByVal sPassword As String, ByVal sServer As String) As Long

Declare Function ReadPipe Lib "npdll.dll" (ByVal hPipe As Long, ByVal sMessage As String, ByVal lNumBytes As Long) As Long
Declare Function WritePipe Lib "npdll.dll" (ByVal hPipe As Long, ByVal sMessage As String) As Long

Declare Sub ClosePipe Lib "npdll.dll" (ByVal hPipe As Long)
