...
## Date:                5/21/08
##
## Description:         This script performs the BCV establish and split for the UK Unisys operators
##
...
`/usr/symcli/bin/symdg -force delete $DG_NAME`;
my $D_RC = $?;

if ($D_RC eq 0) {
   print "OK:     The diskgroup was successfully deleted.\n";
}
else {
   print "Error:  The diskgroup was not deleted, please contact the oncall storage admin\n";
   exit 40;
}
