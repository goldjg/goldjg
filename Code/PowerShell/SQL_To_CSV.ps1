#########################################################################################################
#                                                                                                       #
# SQL_To_CSV Script by Graham Gold                                                                      #
# --------------------------------                                                                      #
...
#     Optional flag that, if set, will display the query results as well as export to CSV file          #
#                                                                                                       #
#                                                                                                       #
# Syntax Examples:                                                                                      #
# .\SQL_To_CSV.ps1 -c CMDB_Prod.con -q IBM_Relationships.sql -output IBM_Relationships.csv -v           #
#    Returns:                                                                                           #
...
#                                                                                                       #
# .\SQL_To_CSV.ps1 -c CMDB_Prod.con -q Unisys_LPAR.sql -output Unisys_LPAR.csv                          #
# -pathq \\##REDACTED##\CMDB\Reconciliation\Automation\                                           #
# -pathout \\##REDACTED##\CMDB\Reconciliation\Automation\ -v                                      #  
#    Returns:                                                                                           #
#    VERBOSE: Query Path supplied: \\##REDACTED##\CMDB\Reconciliation\Automation\                 #
#    VERBOSE: Output Path supplied: \\##REDACTED##\CMDB\Reconciliation\Automation\                #
#    VERBOSE: 4 records extracted from database CMDB_Prod to file                                       #
#    \\##REDACTED##\CMDB\Reconciliation\Automation\Unisys_LPAR.csv using query Unisys_LPAR        #
#                                                                                                       #
#########################################################################################################
    param (
